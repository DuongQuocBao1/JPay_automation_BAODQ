...
/************************************************************************************************
 * 
 * TestCase :: KTC35 - (Write letter button will disappeared in kiosk)
 * Author :: shasan(Shahriar Hasan) , Date ::
 * DataFile :: KioskEmail.xlsx , DataSheet :: KTC35
 * Status :: Completed
 * 
 **************************************************************************************************/

public class KTC35Part1Test extends BaseTestObject{
	...
	@Test(enabled = true, priority = 1, description = "TestCases::KTC-35(Part1)::DesignSteps"
			+ "::13,14,15,16,17(Navigate to facility,enter username,pincode,password and "
	 ...
	 * account details button,click on edit button,uncheck outbound enabled 
	 * checkbox,click on update button and verify update message.
	 * 
	 **********************************************************************************/

	@Test(enabled = true, priority = 2, description = "TestCases::KTC-35(Part1)::DesignSteps::"
			+ "18,19,20,21,22,23,24(Click on handle inmate account link,enter inmateid,"
			+ "click on view inmate account details button,click on edit button,uncheck "
			+ "outbound mail enabled checkbox,click on update button and verify update message.)")
	...
	@Test(enabled = true, priority = 3, description = "TestCases::KTC-35(Part1):: DesignSteps::"
			+ "25(Click sign out button .)")
	public void testEnd() {
	...
	public static Object[] createInstances(Map<String, String>data) {
		return new Object[] { new KTC35Part1Test(data) };
	}
	
	
	public KTC35Part1Test(Map<String, String> data) {
		super(data);
