...
/************************************************************************************************
 * 
 * TestCase :: GrievanceTC_1.05Test(Part1) - (Validate number of active Communication allowed.) 
 * Author :: shasan(Shahriar Hasan) , Date :: DataFile ::
 * KioskEmail.xlsx , DataSheet :: TC_1.05 Status :: Completed
 * 
 **************************************************************************************************/

public class GrievanceTC_105Part1Test extends BaseTestObject {
	...
	private String minCommunicationNum;
	...
	@Test(enabled = true, priority = 1, description = "TestCase::TC_1.05(Part1)::Design "
	 ...
	 * minimum number of communication as 0.click save settings and verify update message.
	 * 
	 **********************************************************************************/

	@Test(enabled = true, priority = 2, description = "TestCase::TC_1.05(Part1)::Design Steps::7,"
			+ "8,9,10,11,12,13,14,15(Click on Administration link,click on facility management,"
			+ "click on communication settings,select facility,select permlock,check grievance "
			+ "enabled checkbox,enter minimum number of communication as 0.click save settings "
			+ "and verify update message.)")
	public void changeSettingsOfStagingAndVerify() {
		...
		jpayStaging().stagingAdminCommunicationsSettings().enterNumActiveCommunicationsAllowed(minCommunicationNum);
	...
	@Test(enabled = true, priority = 3, description = "TestCase::TC_1.05(Part1)::Design "
	...
	@Test(enabled = true, priority = 4, description = "TestCase::TC_1.05(Part1)::Design "
	...
	@Test(enabled = true, priority = 5, description = "TestCase::TC_1.05(Part1)::Design "
	...
	@Test(enabled = true, priority = 6, description = "TestCase::TC_1.05(Part1)::Design "
	...
	@Test(enabled = true, priority = 7, description = "TestCase::TC_1.05(Part1)::Design "
			+ "Steps::34,35,36,37(Click sign out button and verify Login details.)")
	public void endTest() {
	...
	public static Object[] createInstances(Map<String, String> data) {
		return new Object[] { new GrievanceTC_105Part1Test(data) };
	}

	public GrievanceTC_105Part1Test(Map<String, String> data) {
		super(data);
        ...
        minCommunicationNum = data.get("minCommunicationNum");
