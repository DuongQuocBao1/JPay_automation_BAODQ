...
public class KTC34Part1Test extends BaseTestObject{
	...
	@Test(enabled = true, priority = 1, description = "TestCases::KTC-34(Part1)::DesignSteps"
	 ...
	 * account details button,click on edit button,uncheck inbound enabled 
	 * checkbox,click on update button and verify update message.
	 * 
	 **********************************************************************************/

	@Test(enabled = true, priority = 2, description = "TestCases::KTC-34(Part1)::DesignSteps::"
	...
	@Test(enabled = true, priority = 3, description = "TestCases::KTC-34(Part1):: DesignSteps::"
	...
	public static Object[] createInstances(Map<String, String>data) {
		return new Object[] { new KTC34Part1Test(data) };
	}
	
	
	public KTC34Part1Test(Map<String, String> data) {
		super(data);
