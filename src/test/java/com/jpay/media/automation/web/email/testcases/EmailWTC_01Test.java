...
/************************************************************************************************
 * 
 * TestCase :: WTC01 - (User shall be able to create a new account and send letter)
 * Author :: shasan(Shahriar Hasan) , Date :: 07/15/2019
 * DataFile :: Email.xlsx , DataSheet :: WTC01
 * Status :: Completed
 * 
 **************************************************************************************************/

public class EmailWTC_01Test extends BaseTestObject{
	...
	@Test(enabled = true, priority = 1, description = "TestCase :: WTC01::Design Steps::"
	...
	@Test(enabled = true, priority =3, description = "TestCase :: WTC01::Design Steps::"
	...
	@Test(enabled = true, priority = 4, description = "TestCase::WTC01::Design Steps::"
	...
	@Test(enabled = true, priority = 5, description = "TestCase::WTC01::Design Steps::"
	...
	@Test(enabled = true, priority = 6, description = "TestCase::WTC01::Design Steps::"
	...
	@Test(enabled = true, priority = 7, description = "TestCase::WTC01::Design Steps::"
			+ "44,45,46,47,48,49( Click email link,enter email message in the message "
	...
	@Test(enabled = true, priority = 8, description = "TestCase::WTC01::Design Steps::"
	...
	public static Object[] createInstances(Map<String, String>data) {
		return new Object[] { new EmailWTC_01Test(data) };
	}
	
	
	public EmailWTC_01Test(Map<String, String> data) {
		super(data);
