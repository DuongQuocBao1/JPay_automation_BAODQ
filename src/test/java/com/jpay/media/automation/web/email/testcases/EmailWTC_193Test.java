...
/************************************************************************************************
 * 
 * TestCase :: WTC193 - (Verify stamps purchased functionality and send email without universal stamps.)
 * Author :: shasan(Shahriar Hasan) , Date :: 
 * DataFile :: Email.xlsx , DataSheet :: WTC193
 * Status :: Completed
 * 
 **************************************************************************************************/

public class EmailWTC_193Test extends BaseTestObject{
	...
	@Test(enabled = true, priority = 1, description = "TestCases::WTC193::Design Steps::"
	...
	@Test(enabled = true, priority = 2, description = "TestCases::WTC193 :: Design Steps::"
	...
	@Test(enabled = true, priority = 3, description = "TestCases::WTC193:: Design Steps::"
	...
	@Test(enabled = true, priority = 4, description = "TestCases::WTC193::Design Steps::"
			+ "11,12,13,14,15(Click stamp balance bucket and get stamps count and verify"
	...
	@Test(enabled = true, priority = 5, description = "TestCases::WTC193::Design Steps::16,"
	...
	@Test(enabled = true, priority = 6, description = "TestCases::WTC193::Design Steps::"
			+ "24,25,26(Click stamp balance bucket and get stamps count.)")
	public void clickStampBalanceBucketAndVerifyStamps1() {

		jpayEmail().buyStamps().clickStampBalanceBucket();
		jpayEmail().buyStamps().verifyStampsBalanceBucket(JPAY_STAMPS_COUNT,PageConstant.STAMPS_COUNT_1);
		jpayEmail().buyStamps().verifyStampsByFacilityWithoutUniversalStamps(facilityJpay1, JPAY_STAMPS_COUNT,PageConstant.STAMPS_COUNT_1);
	...
	@Test(enabled = true, priority = 7, description = "TestCases::WTC193 :: Design Steps::"
	...
	@Test(enabled = true, priority = 8, description = "TestCases::WTC193::Design Steps::31,"
			+ "32,33,34,35,36,37,38,39(Click compose link,enter email message,click send "
			+ "button,verify warn message,used stamp count,click continue button,verify "
			+ "send confirmation message and number.)")
	...
	@Test(enabled = true, priority = 9, description = "TestCases::WTC193::Design Steps::"
			+ "40,41,42(Click stamp balance bucket and get stamps count.)")
	public void clickStampBalanceBucketAndVerifyStamps2() {

		jpayEmail().buyStamps().clickStampBalanceBucket();
		jpayEmail().buyStamps().verifyStampsBalanceBucket(OHIO_STAMPS_COUNT,PageConstant.STAMPS_COUNT_1);
		jpayEmail().buyStamps().verifyStampsByFacilityWithoutUniversalStamps(facilityOhio1, OHIO_STAMPS_COUNT,PageConstant.STAMPS_COUNT_1);
	...
	@Test(enabled = true, priority = 10, description = "TestCases::WTC193::Design Steps::"
	...
	public static Object[] createInstances(Map<String, String>data) {
		return new Object[] { new EmailWTC_193Test(data) };
	}
	
	
	public EmailWTC_193Test(Map<String, String> data) {
		super(data);
