...
/************************************************************************************************
 * 
 * TestCase :: KTC30(Part-2) - (Suspended Inmate shall not be able to send  VG)
 *                          
...
public class KTC30Part2Test extends BaseTestObject{
	...
	@Test(enabled = true, priority = 1, description = "TestCases::KTC30(Part-2)::DesignSteps"
	...
	@Test(enabled = true, priority = 2, description = "TestCases::KTC30(Part-2)::DesignSteps"
	...
	@Test(enabled = true, priority = 3, description = "TestCases::KTC30(Part-2):: Design "
	...
	public static Object[] createInstances(Map<String, String>data) {
		return new Object[] { new KTC30Part2Test(data) };
	}
	
	
	public KTC30Part2Test(Map<String, String> data) {
		super(data);
