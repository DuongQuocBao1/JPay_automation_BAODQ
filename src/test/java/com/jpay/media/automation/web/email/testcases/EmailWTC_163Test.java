...
/************************************************************************************************
 * 
 * TestCase :: WTC163 - (User shall be able to Add inmate to Inmate Filter System & letter status "Requires Approval (flagged inmate)")
 * Author :: shasan(Shahriar Hasan) , Date ::
 * DataFile :: Email.xlsx , DataSheet :: WTC163
 * Status :: Completed
 * 
 **************************************************************************************************/

public class EmailWTC_163Test extends BaseTestObject{
	...
	@Test(enabled = true, priority = 1, description = "TestCases::WTC-163::DesignSteps"
	...
	@Test(enabled = true, priority = 2, description = "TestCases::WTC-163::Design Steps"
	...
	@Test(enabled = true, priority = 3, description = "TestCases::WTC-163:: Design "
	...
	@Test(enabled = true, priority = 4, description = "TestCases::WTC-163::DesignSteps::"
	...
	@Test(enabled = true, priority = 5, description = "TestCases::WTC-163:: DesignSteps"
	...
	@Test(enabled = true, priority = 6, description =  "TestCases::WTC-163::DesignSteps"
	...
	@Test(enabled = true, priority = 7, description = "TestCases::WTC-163::DesignSteps::"
	...
	@Test(enabled = true, priority = 8, description = "TestCases::WTC-163::DesignSteps::"
	...
	@Test(enabled = true, priority = 9, description = "TestCases::WTC-163:: DesignSteps"
	...
	@Test(enabled = true, priority = 10, description = "TestCases::WTC-163::DesignSteps::"
	...
	@Test(enabled = true, priority = 11, description = "TestCases::WTC-163::DesignSteps::"
	...
	@Test(enabled = true, priority = 12, description = "TestCases::WTC-163::DesignSteps::"
	...
	@Test(enabled = true, priority = 13, description = "TestCases::WTC-163:: Design "
	...
	public static Object[] createInstances(Map<String, String>data) {
		return new Object[] { new EmailWTC_163Test(data) };
	}
	
	
	public EmailWTC_163Test(Map<String, String> data) {
		super(data);
