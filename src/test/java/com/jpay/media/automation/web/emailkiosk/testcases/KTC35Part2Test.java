...
public class KTC35Part2Test extends BaseTestObject{
	...
	@Test(enabled = true, priority = 1, description = "TestCases::KTC-35(Part2)::DesignSteps"
	 ...
	 * account details button,click on edit button,check outbound enabled 
	 * checkbox,click on update button and verify update message.
	 * 
	 **********************************************************************************/

	@Test(enabled = true, priority = 2, description = "TestCases::KTC-35(Part2)::DesignSteps::"
	...
	@Test(enabled = true, priority = 3, description = "TestCases::KTC-35(Part2):: DesignSteps::"
	...
	public static Object[] createInstances(Map<String, String>data) {
		return new Object[] { new KTC35Part2Test(data) };
	}
	
	
	public KTC35Part2Test(Map<String, String> data) {
		super(data);
